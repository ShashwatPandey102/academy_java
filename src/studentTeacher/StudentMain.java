...
import studentTeacher.util.StudentUtils;
...
// 과제의 내용
//1. 학생 삭제
//2. 정렬 (석차 내림차순) 석차조회 만들기(
//3. 예외처리 적용 studentTeacher
//3-1 이름은 한글로만 구성
//3-2 메뉴선택시 지정된 숫자만 입력가능
//3-3 점수 입력시 값의 범위를 0~100사의 값만 지정
...
public class StudentMain {
	public static void main(String[] args) {
		...
		while (true) {
			try {
				int input = StudentUtils.nextInt("1. 조회 2. 등록 3. 수정 4. 삭제 5. 석차 6. 종료");
				switch (input) {
				case 1:
					service.list();
					break;
